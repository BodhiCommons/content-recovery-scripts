...
class BodhiSnapShot:
    ...
    def __init__(
        self,
        url: str = "http://beta.bodhicommons.org/filter/all",
        time_stamp: str = "20160320002127",
    ) -> None:
        ...
        self.web_archive_url: str = (
            f"https://web.archive.org/web/{self.time_stamp}/{self.url}"
        )
    ...
    def find_main_block(self) -> None:
        ...
        main_block: Tag | NavigableString | None = self.soup.find(
            "div",
            {
                "class": "panels-flexible-column panels-flexible-column-filtered_lists_panel-5 panels-flexible-column-first homePageCommon"
            },
        )
    ...
    def find_articles(self) -> None:
        """Find articles."""
        self.article_list = self.main_block.find_all("h2")
    ...
    def __write_urls_to_file(self, page_number: int | str) -> None:
        """Append urls to file."""
    ...
    def scrape_urls(self) -> None:
        ...
        try:
            ...
            self.__write_urls_to_file(page_number="beta")
